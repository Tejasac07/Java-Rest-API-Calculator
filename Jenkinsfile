    ...
    stages{
        stage ('Checkout from github') {
            steps{
                ...
                git branch: "${params.branchName.split('/').last()}", credentialsId: '8ad6a8ce-c66d-4eb0-9877-22489349cfc1', url: 'https://github.com/Tejasac07/Java-Rest-API-Calculator.git'
                sh 'ls -ltr'
            }
        }
        stage ('Build package') {
